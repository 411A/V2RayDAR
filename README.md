...
| --- | --- | --- | --- | --- | --- |
| `bind` | Socket address | `127.0.0.1:27141` | `IP:PORT`, for example `127.0.0.1:27141`, `0.0.0.0:27141`, `192.0.2.23:27141` | Restart required | HTTP bind address for `/subscription`, `/subscription.txt`, `/results`, and `/health`. Use `127.0.0.1` for same-machine clients. Use `0.0.0.0` or a LAN IP for Android/LAN clients. |
