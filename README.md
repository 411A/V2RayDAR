...
| --- | --- | --- | --- | --- | --- |
| `bind` | Socket address | `127.0.0.1:14127` | `IP:PORT`, for example `127.0.0.1:14127`, `0.0.0.0:14127`, `192.0.2.23:14127` | Restart required | HTTP bind address for `/subscription`, `/subscription.txt`, `/results`, and `/health`. Use `127.0.0.1` for same-machine clients. Use `0.0.0.0` or a LAN IP for Android/LAN clients. |
...
```text
http://192.0.2.23:14127/subscription
```
...
```text
http://192.0.2.23:14127/subscription?token=your-generated-token
```
