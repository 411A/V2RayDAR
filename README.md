...
```text
http://192.0.2.23:27141/subscription?token=your-generated-token
```
...
If you use `0.0.0.0:27141` and `sharing.enabled: true`, the endpoint listens on every interface. Anyone on a reachable network may be able to fetch your top configs unless `sharing.require_token` is enabled. Prefer a specific LAN IP such as `192.0.2.23:27141` when possible.
...
- Use the PC LAN IP, for example `bind: 192.0.2.23:27141`.
